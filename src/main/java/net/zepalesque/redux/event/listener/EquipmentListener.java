...
public class EquipmentListener {
    ...
    public static void hurt(LivingHurtEvent event) {
        ...
        if (target != null && !target.level().isClientSide() && event.getSource().getDirectEntity() instanceof Player player && !event.getSource().is(ReduxDamageTypes.EMBER) && event.getAmount() > 1.0) {
